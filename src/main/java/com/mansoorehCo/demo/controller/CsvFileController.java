...
public class CsvFileController {
    ...
    //public CsvFile submit(@RequestParam("csvFile") MultipartFile file, @RequestParam("name") String name) {
    /*@RequestMapping(value = "/applicant/addAttachment", method = RequestMethod.POST, consumes = "multipart/*")
    public Attachment addAttachmentByApplicant(MultipartFile attachment, @RequestParam Long attachmentTypeId) {
        return applicantService.addAttachment(attachment, attachmentTypeId);
    }*/
}
